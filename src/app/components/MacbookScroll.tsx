...
export const MacbookScroll = ({
  ...
  return (
    <div
      id="about"
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:600px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:600px]">
      <div
        style={{
          transform: "perspective(600px) rotateX(-25deg) translateZ(0px)",
      ...
      >
        ...
        <div className="dark:bg-zinc-900 object-cover object-left-top absolute rounded-lg inset-0 h-full w-full">
          asdasdas
